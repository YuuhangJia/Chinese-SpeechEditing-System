...
class StutterSpeechInfer(BaseTTSInfer):
    ...
    def preprocess_input(self, inp):
        ...
        with open('data/processed/libritts/mfa_dict.txt', 'r') as f: # update mfa dict for unseen word
            lines = f.readlines()
        with open('data/processed/libritts/mfa_dict.txt', 'a+') as f:
        ...
        os.system('mfa align -j 2 --clean inference/audio data/processed/libritts/mfa_dict.txt data/processed/libritts/mfa_model.zip inference/audio/mfa_out')
